...
export async function GET(request: Request) {
  ...
  const results: Array<{ type: string; title: string; url: string; excerpt: string; meta: string }> = [];
  ...
  // Sort logic could go here (e.g., exact matches first)
  // For now, we return the raw aggregated list
